...
namespace KS.Foundation
{
    ...
    {
		public static DateTime SafeUniversalDateTime(this DateTime inTime)
		{
		...
		public static string FormatUtcServerString(this DateTime date)
		{
			return date.SafeUniversalDateTime().ToString ("yyyy-MM-ddTHH\\:mm\\:ssZ");
		}

		public static string FormatHttpHeaderString(this DateTime date)
		{
			// Tue, 15 Nov 1994 08:12:31 GMT
			return date.SafeUniversalDateTime().ToString ("R");
		}

		public static DateTime Offset(this DateTime date, double offsetHours)
		{		
			if (date.IsDefined ())				
				return date.AddHours (offsetHours);
			return date;
		}
